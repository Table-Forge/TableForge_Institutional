...
export function BehanceIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" {...props}>
      <path d="M22 7h-7v2h7V7zm1.726 10c-.442 1.297-2.029 3-4.976 3-3.415 0-5.465-2.227-5.465-5.5 0-3.322 2.215-5.5 5.37-5.5 3.518 0 5.094 2.502 4.795 5.75H16.25c.08 1.484 1.118 2.5 2.656 2.5 1.258 0 2.052-.572 2.454-1.25H23.726zM16.275 13h4.637c-.156-1.127-.92-2-2.25-2-1.398 0-2.188.847-2.387 2zm-9.525-4c1.644 0 2.75.767 2.75 2.25 0 1.054-.622 1.83-1.543 2.1 1.272.296 1.993 1.25 1.993 2.5 0 1.777-1.42 2.65-3.35 2.65H0V6.5h6.75zm-3.75 5.5h3.05c.895 0 1.45-.436 1.45-1.15 0-.74-.555-1.15-1.45-1.15H3v2.3zm0 3.7h3.25c.983 0 1.6-.464 1.6-1.25 0-.81-.617-1.25-1.6-1.25H3v2.5z" />
    </svg>
  );
}
