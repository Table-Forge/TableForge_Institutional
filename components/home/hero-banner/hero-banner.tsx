...
import { Flame, MessageSquare, Smartphone } from "lucide-react";
...
import { useForgeScrollytelling } from "./use-forge-scrollytelling";

export function HeroBanner() {
  const rootRef = useRef<HTMLElement>(null);
  useForgeScrollytelling(rootRef);
  ...
  return (
    ...
    >
      ...
      >
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.35)_45%,transparent_72%)] lg:bg-[linear-gradient(90deg,rgba(0,0,0,0.82)_0%,rgba(0,0,0,0.5)_40%,transparent_68%)]" />
        <div className="relative max-w-xl space-y-6 text-center lg:text-left">
          ...
          <h1 className="text-4xl font-black leading-[1.1] tracking-tight text-[#faf3e0] sm:text-5xl">
          ...
          <p className="mx-auto max-w-xl text-base leading-relaxed text-[#D1D1D1] sm:text-lg lg:mx-0">
            O TableForge é o app por geolocalização que conecta você a jogadores, mestres e mesas em lojas físicas parceiras. Defina seu raio de busca e forje novas campanhas.
          </p>
          ...
          <div className="flex flex-col items-center justify-center gap-4 pt-2 sm:flex-row lg:justify-start">
            ...
            <Link href="/taverna">
              <Button size="lg" variant="outline" className="w-full border-[#3a3a3a] bg-black/60 hover:bg-[#1E1E1E] sm:w-auto">
      ...
      <div data-forge="hud" aria-hidden="true" className="pointer-events-none absolute inset-0 z-40 opacity-0">
