...
export const initialBlogPosts: IBlogPost[] = [
  {
    ...
    content: "Quem joga RPG de mesa no Brasil conhece o desafio: organizar uma campanha geralmente significa navegar entre múltiplos grupos de WhatsApp, servidores de Discord caóticos, pastas compartilhadas no Google Drive e conversas perdidas sobre quem vai levar os petiscos.\n\nMais do que isso: e quando um jogador se muda de cidade ou quer encontrar pessoas próximas para rolar dados presencialmente? É aí que a fragmentação se torna uma barreira real.\n\n### A Forja Está Sendo Acesa\nO TableForge não foi concebido apenas como uma ficha digital ou rolador de dados. Ele é a infraestrutura social que faltava para quem vive RPG e board games. Através de geolocalização inteligente, o aplicativo permite que você descubra jogadores em um raio personalizado, conheça lojas e espaços parceiros com mesas prontas para receber sua party, e encontre eventos oficiais organizados na sua região.\n\n### O Papel d'A Taverna\nPara além do aplicativo móvel, nosso portal e a comunidade permanente da Taverna funcionam como um grande centro de conhecimento duradouro. Guias como este, discussões sobre sistemas, procura de mesas por estado e debates sobre condução de narrativas garantem que o conteúdo permaneça pesquisável e acessível a qualquer momento.",
...
export const initialBlogComments: Record<number, IBlogComment[]> = {
  1: [
    ...
    },
    {
      ...
      content: "A Taverna com discussões permanentes vai salvar a vida de quem perde posts nos grupos de Discord. Parabéns!",
